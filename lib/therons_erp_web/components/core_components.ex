defmodule TheronsErpWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(TheronsErpWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(TheronsErpWeb.Gettext, "errors", msg, opts)
    end
  end
